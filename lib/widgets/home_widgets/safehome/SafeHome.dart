...
//get current permission by using geocoder dependencies
          ...
          child: Row(
            children: [
              Expanded(
                ...
                children: [
                  ListTile(
                    title: Text("Send Location",style: TextStyle(color: Colors.black),),
                    subtitle: Text("Share Location",style:TextStyle(color: Colors.black),),
                  ),
                ],
              )),
              ClipRRect(
                  borderRadius: BorderRadius.circular(20),
                  child: Image.asset('assets/send_location.jpg')),
            ],
          ),
        ),
      ),
